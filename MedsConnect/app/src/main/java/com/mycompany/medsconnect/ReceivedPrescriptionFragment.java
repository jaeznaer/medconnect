...
public class ReceivedPrescriptionFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_received_prescription, container, false);
    }
    ...
    private void getAllImages() {
        class GetAllImages extends AsyncTask<String,Void,String>{
            ...
            protected String doInBackground(String... params) {
                ...
                return rh.sendGetRequest(params[0]);
            }
        }
        GetAllImages gai = new GetAllImages();
        gai.execute(Config.URL_IMAGES);
    }
    ...
    public void getUserDetails(){
            Medicine.getInstance().setCustomerEmail(email);
            Medicine.getInstance().setOrderDetails(details);
            FragmentTransaction transaction = getFragmentManager().beginTransaction();
            transaction.replace(R.id.frame_layout, new CustomerOrderDetailsFragment(), "visible");
